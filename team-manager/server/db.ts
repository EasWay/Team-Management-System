...
import pg from "pg";
const { Pool } = pg;
import { InsertUser, users, teamMembers, InsertTeamMember, TeamMember, auditLogs, InsertAuditLog, teams, InsertTeam, Team, teamMembersCollaborative, InsertTeamMemberCollaborative, TeamMemberCollaborative, teamInvitations, InsertTeamInvitation, TeamInvitation, tasks, InsertTask, Task, clients, InsertClient, Client, projects, InsertProject, Project, projectFiles, InsertProjectFile, ProjectFile, activities, InsertActivity, Activity, repositories, InsertRepository, Repository, messages, Message, InsertMessage, metaAccounts, MetaAccount, InsertMetaAccount } from "../drizzle/schema";

// Re-export schemas for use in route handlers
export { metaAccounts, type MetaAccount, type InsertMetaAccount };
